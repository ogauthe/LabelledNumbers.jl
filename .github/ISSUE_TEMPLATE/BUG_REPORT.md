---
name: LabelledNumbers.jl bug report
about: Create a bug report to help us improve LabelledNumbers.jl
...
[YOUR OUTPUT HERE]
```
 - Output from `using Pkg; Pkg.status("LabelledNumbers")`:
```julia
julia> using Pkg; Pkg.status("LabelledNumbers")
[YOUR OUTPUT HERE]
```
